...
module.exports = async (req, res) => {
  ...
  if (!first_name || !last_name || !age || !parent_email || !program) {
  ...
  try {
          ...
          <div style="border: 1px solid #e5e7eb; border-top: none; border-radius: 0 0 8px 8px; padding: 24px;">
            <table style="width: 100%; border-collapse: collapse;">
              <tr style="border-bottom: 1px solid #f3f4f6;">
                ...
                <td style="padding: 10px 0; font-weight: 600;">${first_name} ${last_name}</td>
              </tr>
              <tr style="border-bottom: 1px solid #f3f4f6;">
                <td style="padding: 10px 0; color: #6b7280; font-size: 13px;">AGE</td>
              ...
              <tr style="border-bottom: 1px solid #f3f4f6;">
                ...
                <td style="padding: 10px 0;"><a href="mailto:${parent_email}">${parent_email}</a></td>
              </tr>
              <tr style="border-bottom: 1px solid #f3f4f6;">
              ...
              <tr style="border-bottom: 1px solid #f3f4f6;">
                <td style="padding: 10px 0; color: #6b7280; font-size: 13px;">LOCATION</td>
    ...
    await resend.emails.send({
      ...
      subject: `We've received ${first_name}'s registration — ProBall`,
      html: `
        <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; padding: 24px;">
          <div style="background: #bc0008; padding: 20px 24px; border-radius: 8px 8px 0 0;">
          ...
          <div style="border: 1px solid #e5e7eb; border-top: none; border-radius: 0 0 8px 8px; padding: 24px;">
            ...
            <p style="color: #374151;">We've received ${first_name}'s registration for <strong>${program}</strong>${location ? ` at ${location}` : ''}.</p>
            ...
            <div style="margin: 24px 0; background: #fef2f2; border-left: 4px solid #bc0008; padding: 12px 16px; border-radius: 0 6px 6px 0;">
              <p style="margin: 0; font-size: 14px; color: #bc0008; font-weight: 600;">Your first 4 weeks are free — no lock-in, no commitment.</p>
            </div>
