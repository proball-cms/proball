...
(function () {
  ...
  var formFields = ''
    ...
    + '<div><label class="pb-label" for="pb-program">Interested Program</label><select class="pb-select" id="pb-program" name="program" required><option value="">Select a program…</option><option>Miniball (Ages 5–10)</option><option>Academy (Ages 5+)</option><option>Teams / Competition (Ages 5–13)</option><option>Not sure — advise me</option></select></div>'
